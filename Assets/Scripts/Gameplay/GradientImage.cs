...
namespace FallenAngel.Gameplay
{
    ...
    public class GradientImage : Graphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            vh.AddVert(new Vector3(rect.xMin, rect.yMin), bottomColor, Vector2.zero); // 0 左下
            vh.AddVert(new Vector3(rect.xMin, rect.yMax), topColor, Vector2.zero);    // 1 左上
            vh.AddVert(new Vector3(rect.xMax, rect.yMax), topColor, Vector2.zero);    // 2 右上
            vh.AddVert(new Vector3(rect.xMax, rect.yMin), bottomColor, Vector2.zero); // 3 右下
